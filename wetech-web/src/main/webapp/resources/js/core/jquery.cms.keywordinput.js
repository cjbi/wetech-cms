(function($) {
	...
	return "<div class='keyword-in'><span class='am-badge am-badge-secondary am-radius'>" + val + "</span><a href='#' class='am-close keyword-shut'>&times;</a><input type='hidden' name='aks' value='" + val + "'/></div>";
    }
})(jQuery)