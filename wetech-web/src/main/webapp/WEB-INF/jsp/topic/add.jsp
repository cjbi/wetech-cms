...
<body>
			...
			<div class="am-u-sm-12">
				<form class="am-form am-form-horizontal">
					<div class="am-form-group">
						...
						<div class="am-u-sm-8">
							<input type="text" placeholder="输入你的文章标题(必填)" required>
						</div>
					...
					<div class="am-form-group">
						...
						<div class="am-u-sm-8">
							<input type="text" placeholder="指定你的文章所属栏目(必填)" required>
						</div>
						<div class="am-u-sm-2"></div>
					</div>
					<div class="am-form-group">
					...
					<div class="am-form-group">
						...
						<div class="am-u-sm-8">
							<label class="am-checkbox-line"> <input type="radio" name="status" value="0" />不推荐
							</label> <br> <label class="am-checkbox-line"> <input type="radio" name="status" value="1" />推荐
							</label>
						</div>
						<div class="am-u-sm-2"></div>
					</div>
					...
					<div class="am-form-group">
						...
						<div class="am-u-sm-8">
							<input type="text" id="keyword" placeholder="请输入关键字，通过逗号或者回车确认(最多五个关键字，不能重复)">
						</div>
						<div class="am-u-sm-2"></div>
					</div>
					<div class="am-form-group">
					...
					<div class="am-form-group">
						...
						<div class="am-u-sm-8 am-text-right">
							<button type="button" class="am-btn am-btn-primary am-radius">发表文章</button>
							<button type="button" class="am-btn am-btn-warning am-radius">重置</button>
						</div>
						<div class="am-u-sm-2"></div>
					</div>
				</form>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/xheditor/jquery/jquery-1.8.3.min.js"></script>
	...
	<script src="<%=request.getContextPath()%>/resources/js/topic/add.js"></script>
</body>
</html>
