			...
			<div class="am-panel-group">
				...
				<section class="am-panel am-panel-default">
					...
					<div class="am-panel-bd">
						<a href="" class="am-badge am-badge-primary am-radius">amaze</a> <a href="" class="am-badge am-badge am-radius">妹纸 UI</a> <a href=""
							class="am-badge am-badge-warning am-radius">HTML5</a> <a href="" class="am-badge am-badge am-radius">这是标签</a>
					</div>
				</section>
			</div>
		</div>
					...
					<c:if test="${datas.total gt 0 }">
						<ul class="am-list">
							<c:forEach items="${datas.datas}" var="topic">
								<li class="am-g am-list-item-desced"><a href="<%=request.getContextPath() %>/topic/${topic.id}" class="am-list-item-hd"><h2>${topic.title }</h2></a>
